...
:author: Kaushik Rattawa and Mehul Jain
:date: Dec 25, 2024
"""
import os
...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_rviz_urbot/src/custom_cobot_ros2/moveit_config_custom_cobot/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_rviz_urbot/install/moveit_config_custom_cobot/share/moveit_config_custom_cobot/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='custom_cobot_280',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'description_cobot'
    urdf_filename = 'custom_cobot_280.urdf.xacro'
    rviz_config_filename = 'custom_cobot_280_description.rviz'
