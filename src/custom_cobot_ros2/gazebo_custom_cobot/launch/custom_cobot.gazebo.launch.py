...
def generate_launch_description():
    ...
    package_name_gazebo = 'gazebo_custom_cobot'
    package_name_description = 'description_cobot'
    package_name_moveit = 'moveit_config_custom_cobot'

    default_robot_name = 'custom_cobot_280'
